...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/entrustHouse3.js?v=${ver}"></script>
	<style>
...
<section>
	...
	<ul class="editIntroList clearfix" style="margin-top: 0;border-top: 1px solid #f8e7b9;">
		...
		<li>
			...
			<div id="stateRadioBtn" class="stateRadio_OFF"></div>
		</li>
		<li>
			<label class="label_10">房源类别</label>
			<div id="houseType" class="flexBox houseType">
				<span class="" data-opion="recommend">推荐</span>
...
<div class="popTipBox" style="display: none;">
	...
	<div id="vrlist" class="popTipCon" style="display: none;">
		 ...
		 <ul class="txtBar clearOv">
		     ...
		     <li style="display:none;"><input id="vrRoom" class="" placeholder="选择户型" /></li>
...
<script>
	$(function(){
		...
		entrustHouse3.vars.houseid="${houseid}";
		entrustHouse3.vars.city="${store.city}";
		entrustHouse3.vars.clientopenid="${clientopenid}";
		entrustHouse3.init();
	});
</script>
</html>
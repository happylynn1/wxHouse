...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/toRentSale.js?v=${ver}"></script>
</head>
<body>
<section>
<div class="fox_fixt">
	<div class="SouBox">
         ...
         <label><form action="javascript:toRentSale.setKeys()"><input type="text" class="input" placeholder="搜索">
         <i></i></form></label>
    </div>
    <!--筛选条-->
	...
	<ul id ="priceSale" class="sortCon"  style="display:none;">
	    <li data-name="" class="activeOn">全部</li>
	...
	<ul id ="priceRent" class="sortCon"  style="display:none;">
	    <li data-name="" class="activeOn">全部</li>

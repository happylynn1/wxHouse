...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/toRent1.js?v=${ver}"></script>
	<style>
...
<section>
	...
	<ul class="editIntrotext clearfix" style="margin-top: 0;border-top: 1px solid #c8c8c8;">
		...
		<li>
			<label class="labell_4">方  式</label>
			<input class="" id="renttype_input" placeholder="请选择方式" />
            <span class="xzxqIconl" id="renttype_span"><img src="${path}res/images/left_ioc_1.png"></span>
		</li>
		<li>
			<label class="labell_5">租  金</label>
			<input class="" id="price_input" type='number' placeholder="请输入租金，单元：元" />
		</li>
		<li>
			<label class="labell_6">户  型</label>
		...
		<li>
			<label class="labell_7">面  积</label>
...
<div class="popTipBoxL" style="display:none;">
	...
	<!--选择方式-->
	<div class="popTipConL qitaBoxL" id="renttype_div" style="display:none;">
	     <h4>
	        <b>选择方式</b>
	     </h4>
	     <div class="intrChoListL">

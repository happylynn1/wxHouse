...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/dealRentRequire.js?v=${ver}"></script>
	<style>
...
<section>
	...
	<ul class="editIntrotext clearfix" style="margin-top: 0;border-top: 1px solid #c8c8c8;">
		...
		<li>
			<label class="labell_4">方  式：</label><span id="renttype_span">合租</span>
		</li>
		<li>
			<label class="labell_5">租  金：</label><span id="price_span">2600元</span>
		</li>
		<li>
...
$(function(){
	...
	dealRentRequire.vars.requireid = "${requireid}";
	dealRentRequire.init();
});
</script>
</html>
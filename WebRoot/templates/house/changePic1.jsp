...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/changePic1.js?v=${ver}"></script>
</head>
...
<section>
	...
	<a class="sureModifyBtn" id="changePic2" >设置封面图</a>
</section>
<div id="progressbar">
    <div id='progress'></div>
    <p></p>
...
<script>
	$(function(){
		...
		changePic1.type="${type}";
		changePic1.houseid="${houseid}";
		changePic1.init();
	});
</script>
</html>
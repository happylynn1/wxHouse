...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/entrustHouse2.js?v=${ver}"></script>
</head>
...
<section>
	...
	<a class="sureModifyBtn" id="entrusHouse3" >填写房源信息</a>
</section>
</body>
<script>
	$(function(){
		ext.setvars("${path}","${storeId}", "${openid}");
		entrustHouse2.houseid="${houseid}";
		entrustHouse2.clientopenid="${clientopenid}";
		entrustHouse2.init();
	});
</script>
</html>
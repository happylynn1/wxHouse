...
<html>
  <head lang="en">
	...
	<script type="text/javascript" src="${path}res/js/clientHousePub4.js?v=${ver}"></script>
</head>
<body>
<section>
    <div class="sucTips"><span>房源已保存成功！</span></div>
    <h5 class="mesTips">您可以选择一位经纪人帮您发布房源</h5>
...
<script>
	$(function(){
		...
		clientHousePub4.houseid="${houseid}";
		clientHousePub4.init();
	});
</script>
</html>